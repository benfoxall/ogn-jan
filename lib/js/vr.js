(function(global, navigator, document){
  ...
  function VideoRecognition(options){
  ...
  VideoRecognition.prototype.getUserMedia = function(){
    var self = this;
  ...
  VideoRecognition.prototype._waitForVideo = function(){
  ...
  VideoRecognition.prototype._process = function(){
  ...
  VideoRecognition.prototype._workerHandler = function (oEvent) {
  ...
  VideoRecognition.prototype.attachTo = function(selector){
  ...
  VideoRecognition.prototype.on = function(name, fn){
    if(name && fn) this.listeners.push([name, fn])
    return this;
  }

  VideoRecognition.prototype.emit = function(name, value){
  ...
  VideoRecognition.prototype.calibrated = function(){
  ...
  global.VideoRecognition = VideoRecognition;
